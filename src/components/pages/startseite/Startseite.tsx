...
export function Startseite() {
  return (<Container>
    <h1>Über Vestaland</h1>
    <p><img src={startseiteBild} width={200} className={'float-left'} alt={'Eine Kochapp hilft in der Küche'}/> Herzlich
      willkommen bei Vestaland, Ihrer
    ...
    {/*roundedCircle={true}*/}
    <p><img src={startseiteBild2} width={200} className={'float-right'} alt={'Eine Kochapp hilft in der Küche'}/> Falls
      Sie gerade
